...
>
> **Prototype 來源 commit：** `cff1356ad656`（2026-09-08）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
